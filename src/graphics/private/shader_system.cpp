...
namespace muse
{
    ShaderSystem::ShaderSystem(std::string_view vertex_shader_source,
    ...
    void ShaderSystem::add_uniform(std::string_view uniform_name)
    {
        uniform_map_[uniform_name] = glGetUniformLocation(handle_, uniform_name.data());
    }

    void ShaderSystem::remove_uniform(std::string_view uniform_name)
    {
        uniform_map_.erase(uniform_name);
    }

    void ShaderSystem::set_value(std::string_view uniform_name, std::int32_t value)
    {
