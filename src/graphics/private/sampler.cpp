...
GLenum to_opengl(muse::SamplerAddressMode mode)
{
    switch(mode)
    {
    case muse::SamplerAddressMode::MIRRORED_REPEAT: return GL_MIRRORED_REPEAT; break;
    case muse::SamplerAddressMode::REPEAT: return GL_REPEAT; break;
    case muse::SamplerAddressMode::CLAMP_TO_EDGE: return GL_CLAMP_TO_EDGE; break;
    case muse::SamplerAddressMode::CLAMP_TO_BORDER: return GL_CLAMP_TO_BORDER; break;
    }
...
GLenum to_opengl(muse::SamplerFilter filter)
{
    switch(filter)
    {
    case muse::SamplerFilter::NEAREST: return GL_NEAREST; break;
    case muse::SamplerFilter::LINEAR: return GL_LINEAR; break;
    }
...
namespace muse
{
        ...
        , specification_(spec)
    {
        ...
        {
            if(specification_.min_filter == SamplerFilter::LINEAR && 
